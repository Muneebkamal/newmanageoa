 <div class="modal fade" id="addBundleBuyList" tabindex="-1" role="dialog" aria-labelledby="addAttachmentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bundleModalLabel">Add Bundled Items to Buy List</h5>
            ...
            <div class="modal-body"  style="max-height: 500px; overflow-y: auto;">
                ...
                <div class="row float-end">
                    <div class="text-right float-end mb-2">
                        <div class="btn-group buylist-group">
                            <button type="button" class="btn btn-primary  buylist-button" onclick="saveBuyListBundleItems()">
                              Select Buylist
                            </button>
                            <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                              <span class="visually-hidden">Toggle Dropdown</span>
                            </button>
                            <ul class="dropdown-menu buylist-dropdown"></ul>
                        </div>
            ...
            <div class="modal-footer">
                <div class="button-group text-center mt-4">
                    ...
                    <div class="btn-group buylist-group" id="addToBuyListBtn" style="display: none;">
                        <button type="button" class="btn btn-primary  buylist-button" onclick="saveBuyListBundleItems()">
                          Select Buylist
                        </button>                      
                        <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
